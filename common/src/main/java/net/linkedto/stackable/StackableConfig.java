...
public final class StackableConfig {
    ...
    public static void setConfigDir(Path dir) {
        configPath = dir.resolve("stackable.json");
    }
    ...
    public static void load() {
        ...
        if (Files.exists(configPath)) {
            try (var reader = Files.newBufferedReader(configPath)) {
                ...
                System.err.println("[Stackable] Error loading config: " + e.getMessage());
            }
        }
    ...
    private static void resolveEntries() {
        ...
        for (var entry : rawEntries.entrySet()) {
            ...
            if (key.startsWith("#")) {
                ...
                if (id != null) {
                    registry.get(id).ifPresent(item -> resolvedSizes.put(item.value(), size));
                }
            }
        }
    }
    ...
    public static void save() {
        try {
            ...
            System.err.println("[Stackable] Error saving config: " + e.getMessage());
        }
    }
